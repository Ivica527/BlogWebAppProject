          ...
          <div class="col-md-12">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Blog Sliders Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Title</label>
                        <form:input type="text" class="form-control" placeholder="Enter sliders title" path="title"/>
                        <form:errors cssClass="text-danger" path="title"/>
                      </div>
                      <div class="form-group">
                        <label>Image</label>
                        <form:input type="text" class="form-control" placeholder="Enter sliders image url" path="image"/>
                        <form:errors cssClass="text-danger" path="image"/>
                      </div>
                                            
                      <div class="form-group">
                        <label>Title button</label>
                        <form:input type="text" class="form-control" placeholder="Enter sliders title button" path="titleButton"/>
                        <form:errors cssClass="text-danger" path="titleButton"/>
                      </div>
                      <div class="form-group">
                        <label>Url button</label>
                        <form:input type="text" class="form-control" placeholder="Enter sliders url button" path="urlButton"/>
                        <form:errors cssClass="text-danger" path="urlButton"/>
                      </div>                      
                    </div>
                  </div>
                  
                  <div class="custom-control custom-checkbox">
                          <form:checkbox class="custom-control-input" id="customCheckbox1" path="isVisible"/>
                          <label for="customCheckbox1" class="custom-control-label">Is visible on main page</label>
                  </div>
                </div>
                <!-- /.card-body -->
