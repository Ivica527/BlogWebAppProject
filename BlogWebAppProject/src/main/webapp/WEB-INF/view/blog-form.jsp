                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Title</label>
                        <form:input type="text" class="form-control" placeholder="Enter blog title" path="title"/>
                      ...
                      <div class="form-group">
                        <label>Text</label>
                        <form:textarea type="text" class="form-control" placeholder="Enter blog text" path="text"/>
					...
					<div class="form-group">
                      ...
                      <div class="form-group">
                        <label>Tags</label>
                        <form:select class="form-control" path="tags" items="${tagList}" itemValue="id" itemLabel="name" multiple="true"/>
                      </div>
                    </div>
                  </div>
                </div>
