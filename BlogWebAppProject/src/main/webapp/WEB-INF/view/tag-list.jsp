            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  ...
                  <sec:authorize access="hasRole('admin')"> 
                  <a href="tag-form" class="btn btn-info btn-sm">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  <thead>                  
                    <tr>
                      <th class="text-center" style="width: 20%;font-size: 2rem;">ID</th>
                      <th style="width: 55%;font-size: 2rem;">NAME</th>
                      <sec:authorize access="hasRole('admin')">                      
                      <th class="text-center" style="width: 25%;font-size: 2rem;">ACTIONS</th>
                      </sec:authorize> 
                    </tr>
                  </thead>
                  <tbody id="sort-list">
                  ...
                  <tr>
                      <td class="text-center" style="font-size: 1.5rem;"> ${tag.id}
                      </td>
                      <td style="font-size: 1.5rem;text-transform: uppercase; ">${tag.name}
                      </td>
                      <sec:authorize access="hasRole('admin')">
                      <td class="text-center">
                        <div class="btn-group">
                          <a href="tag-form-update?id=${tag.id}" class="btn btn-info btn-sm">
                            <i class="fa-solid fa-pen-nib"></i>
                              </i><div>Edit</div>
                          </a>
                          <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete-modal-${tag.id}">
                     ...
                     <div class="modal fade show" id="delete-modal-${tag.id}">
				      <div class="modal-dialog">
				        <div class="modal-content bg-info">
				          ...
				          <div class="modal-footer justify-content-between">
				            ...
				            <a href="tag-delete?id=${tag.id}" class="btn btn-danger btn-outline-light">Delete</a>
				          </div>
				        </div>
				        <!-- /.modal-content -->
				      </div>
