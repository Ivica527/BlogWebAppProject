            ...
            <div class="card">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  <thead>                  
                    <tr>
                      <th class="text-center" style="width: 5%;font-size: 1.2rem;">ID BLOG</th>
                      <th style="width: 10%;font-size: 1.2rem;">NAME</th>
                      <th style="width: 35%;font-size: 1.2rem;">TEXT</th>
                      <th style="width: 15%;font-size: 1.2rem;">EMAIL</th>
                     <th style="width: 10%;font-size: 1.2rem;">DATE</th> 
                     <th style="width: 10%;font-size: 1.2rem;">IS COMMENT SEEN</th>
                      <th class="text-center" style="width: 10%;font-size: 1.2rem;">IS VSIBLE ON BLOG POST PAGE</th>                      
                      <th class="text-center" style="width: 5%;font-size: 1.2rem;">ACTIONS</th>
                    </tr>
                  </thead>
                  <tbody id="sort-list">
                  ...
                  <tr>
                      <td class="text-center" style="font-size: 1.2rem;">${comment.idBlog}
                      </td>
                      <td  style="font-size: 1.2rem;">${comment.name}
                      </td>
                      <td  style="font-size: 1.2rem;">${comment.text}
                      </td>
                      <td  style="font-size: 1.2rem;">${comment.email}
                      </td>
                      <td  style="font-size: 1.2rem;">${comment.date}
                      </td>
                      <td  class="text-center">                      
                      <c:if test="${comment.isSeen}">
                        	<a href="#" class="btn btn-block btn-info">
                            	<i style="font-size: 1.2rem;">SEEN</i>
                          	</a>                        
                        </c:if> 
                        <c:if test="${!comment.isSeen}">
                        	<a href="comment-isSeen?id=${comment.id}" class="btn btn-block btn-warning">
                     ...
                     <td class="text-center">
                      <c:if test="${comment.isSeen}">
						...
						<a href="comment-isEnabled?id=${comment.id}" class="btn btn-info">
						<i style="font-size: 1.5rem;">YES</i>
						</a>
						
						</c:if>					
						<c:if test="${!comment.isEnabled}">					
						<a href="comment-isEnabled?id=${comment.id}" class="btn btn-danger">
                      ...
                      <td class="text-center">
                        <div class="btn-group">                          
                          <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete-modal-${comment.id}">
                     ...
                     <div class="modal fade show" id="delete-modal-${comment.id}">
				      <div class="modal-dialog">
				        <div class="modal-content bg-info">
				          ...
				          <div class="modal-footer justify-content-between">
				            ...
				            <a href="comment-delete?id=${comment.id}" class="btn btn-danger btn-outline-light">Delete</a>
				          </div>
				        </div>
				        <!-- /.modal-content -->
				      </div>
