              ...
              <form:form role="form" action="user-change-password-action" modelAttribute="changePassword">                       
                ...
                <p style="color: red; background-color: yellow;">${message2}</p>                                  
                  ...
                  <div class="form-group">
                    ...
                    <form:errors cssClass="text-danger" path="newpassword"/>
                  </div>
                  
                  <div class="form-group">
                    <label>Confirm Pasword</label>
                    <form:input path="confirmpassword" type="password" class="form-control" placeholder="Enter confirm new password"/>
