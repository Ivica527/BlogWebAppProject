          ...
          <div class="col-md-6">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Blog Users Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <form:hidden path="username"/>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Name</label>
                    <form:input path="name" type="text" class="form-control" placeholder="Enter password"/>
                  ...
                  <div class="form-group">
                    ...
                    <form:errors cssClass="text-danger" path="surname"/>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <form:input path="phoneNumber" type="text" class="form-control" placeholder="Enter your phone number"/>
                    <form:errors cssClass="text-danger" path="phoneNumber"/>
                  </div>
                  <div class="form-group">
                    <label>Email</label>
                    <form:input path="email" type="text" class="form-control" placeholder="Enter you email"/>
                    <form:errors cssClass="text-danger" path="email"/>
                  </div>
                  <div class="form-group">
                        <label>Role</label>
                        <form:select class="form-control" path="authorities" items="${roles}" itemValue="authority" itemLabel="authority" multiple="true"/>
                  </div>
                </div>
                <!-- /.card-body -->
