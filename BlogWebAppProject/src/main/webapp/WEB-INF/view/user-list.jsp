          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All Blog Users</h3>
                <div class="card-tools">
                 
                   <sec:authorize access="hasRole('admin')">  
                  <a href="user-form" class="btn btn-info btn-sm">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  <thead>                  
                    <tr>                       
                      <th class="text-center" style="width: 15%;font-size: 1.2rem;">USERNAME</th>                      
                      <th class="text-center" style="width: 40%;font-size: 1.2rem;">IMAGE</th>
                      <th style="width: 15%;font-size: 1.2rem;">NAME</th>
                      <th style="width: 20%;font-size: 1.2rem;">SURNAME</th> 
                      <sec:authorize access="hasRole('admin')">                     
                      <th class="text-center" style="width: 10%;font-size: 1.2rem;">IS ENABLED</th>
                       </sec:authorize> 
                      <sec:authorize access="hasRole('admin')">  
                      <th class="text-center" style="width: 10%;font-size: 1.2rem;">ACTIONS</th>
                      </sec:authorize>                      
                    </tr>
                  </thead>
                  <tbody id="sort-list">
                  ...
                  <tr>
                      ...
                      <td class="text-center" style="font-size: 1.4rem;">${user.username}
                      <br></br>
                      <a href="information-about-author?username=${user.username}" class="btn btn-sm btn-primary">
                      <i class="fas fa-user"></i> View Profile
                    </a>
                      
                      </td>                      
                      <td class="text-center"><img src="${user.image}" style="max-width: 140px;">
                      </td>                       
                      <td style="font-size: 1.2rem;text-transform: uppercase;">${user.name}</td>
                      <td style="font-size: 1.2rem;text-transform: uppercase;">${user.surname}</td> 
					...
					<td class="text-center">
                        <div class="btn-group">
                          <a href="user-form-update?username=${user.username}" class="btn btn-info btn-sm">
                            <i class="fa-solid fa-pen-nib"></i>
                              </i><div>Edit</div>
                          </a>
                          <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete-modal-${user.username}">
                     ...
                     <div class="modal fade show" id="delete-modal-${user.username}">
				      <div class="modal-dialog">
				        <div class="modal-content bg-info">
				          ...
				          <div class="modal-footer justify-content-between">
				            ...
				            <a href="user-delete?username=${user.username}" class="btn btn-danger btn-outline-light">Delete</a>
				          </div>
				        </div>
				        <!-- /.modal-content -->
				      </div>
