        ...
        <main class="posts-listing col-lg-8"> 
          <div class="container">
            <h2 class="mb-3 author d-flex align-items-center flex-wrap">
              <div class="avatar"><img src="${user.image}" alt="..." class="img-fluid rounded-circle" style="height: 7rem;"/></div>
                <div class="title">
            ...
            <nav aria-label="Page navigation example">
              <ul class="pagination pagination-template d-flex justify-content-center">
                <c:if test="${k==1}">
		           ...
		           <c:if test="${k>1}">
		           <li class="page-item"><a class="page-link" href="pagination-blog-author-page?k=${k-1}&name=${user.name}"><i class="fa fa-angle-left"></i></a></li>
		           </c:if>		           
		           
		           <c:forEach var="k" begin="1" end="${c}">
		           <c:if test="${k==b}">
		           <li class="page-item active"><a class="page-link" href="pagination-blog-author-page?k=${k}&name=${user.name}">${k}</a></li>
		           </c:if>
		           <c:if test="${k!=b}">
		           <li class="page-item"><a class="page-link" href="pagination-blog-author-page?k=${k}&name=${user.name}">${k}</a></li>
		           </c:if>
		           </c:forEach>           
		           ...
		           <c:if test="${k<c}">
		           <li class="page-item"><a class="page-link" href="pagination-blog-author-page?k=${k+1}&name=${user.name}"><i class="fa fa-angle-right"></i></a></li>
		           </c:if>
              </ul>
            </nav>
          </div>
