        ...
        <main class="posts-listing col-lg-8"> 
          <div class="container">
            <h2 class="mb-3">Category "${category.name}"</h2>            
              <div class="row">              
              <c:forEach  var="blog" items="${category.blogs}">              
              ...
              <ul class="pagination pagination-template d-flex justify-content-center">
                ...
                <c:if test="${k==1}">
		           ...
		           <c:if test="${k>1}">
		           <li class="page-item"><a class="page-link" href="pagination-blog-category-page?k=${k-1}&name=${category.name}"><i class="fa fa-angle-left"></i></a></li>
		           </c:if>		           
		           
		           <c:forEach var="k" begin="1" end="${c}">
		           <c:if test="${k==b}">
		           <li class="page-item active"><a class="page-link" href="pagination-blog-category-page?k=${k}&name=${category.name}">${k}</a></li>
		           </c:if>
		           <c:if test="${k!=b}">
		           <li class="page-item"><a class="page-link" href="pagination-blog-category-page?k=${k}&name=${category.name}">${k}</a></li>
		           </c:if>
		           </c:forEach>           
		           ...
		           <c:if test="${k<c}">
		           <li class="page-item"><a class="page-link" href="pagination-blog-category-page?k=${k+1}&name=${category.name}"><i class="fa fa-angle-right"></i></a></li>
		           </c:if>
