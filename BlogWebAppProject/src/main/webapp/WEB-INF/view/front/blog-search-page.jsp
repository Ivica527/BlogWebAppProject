    ...
    <div class="container">
      <div class="row">
        ...
        <main class="posts-listing col-lg-8"> 
          <div class="container">
          <c:if test="${blogSearchList.size() == 0}">              
              <h3 class="mb-3">There is no similar blog here with word "${word}"</h3>
              </c:if>              
              <c:if test="${blogSearchList.size() > 0}">              
            ...
            <div class="row">
              ...
              <div class="post col-xl-6">
                ...
                <div class="post-details">
                  ...
                  <footer class="post-footer d-flex align-items-center"><a href="blog-author-page?name=${blog.user.name}" class="author d-flex align-items-center flex-wrap">
            ...
            <nav aria-label="Page navigation example">
              <ul class="pagination pagination-template d-flex justify-content-center">
                ...
                <c:if test="${k==1}">
		           ...
		           <c:if test="${k>1}">
		           <li class="page-item"><a class="page-link" href="pagination-blog-search-page?k=${k-1}&word=${word}"><i class="fa fa-angle-left"></i></a></li>
		           </c:if>
		           
		           
		           <c:forEach var="k" begin="1" end="${c}">
		           <c:if test="${k==b}">
		           <li class="page-item active"><a class="page-link" href="pagination-blog-search-page?k=${k}&word=${word}">${k}</a></li>
		           </c:if>
		           <c:if test="${k!=b}">
		           <li class="page-item"><a class="page-link" href="pagination-blog-search-page?k=${k}&word=${word}">${k}</a></li>
		           </c:if>
		           </c:forEach>           
		           ...
		           <c:if test="${k<c}">
		           <li class="page-item"><a class="page-link" href="pagination-blog-search-page?k=${k+1}&word=${word}"><i class="fa fa-angle-right"></i></a></li>
		           </c:if>      
