  ...
  <div class="content-wrapper">
    ...
    <div class="card-header bg-info color-palette">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="lead"><b>Name : ${user.name}</b></h2>
                      <h2 class="lead"><b>Surname : ${user.surname}</b></h2>
                      <h2 class="lead"><b>Username : ${user.username}</b></h2>
                      <p class="text-muted text-sm"><b>About: </b> Web Designer / UX / Graphic Artist / Coffee Lover </p>
                      
                    
                    <p class="text-muted text-sm"><b>About myself: </b> 
                    ...
                    <ul class="ml-4 mb-0 fa-ul text-muted">
                        ...
                        <li class="small"><span class="fa-li"><i class="fa-solid fa-at"></i></span> Email #: ${user.email}</li>
                      </ul>
                    </div>
                    <div class="col-5 text-center">
                      <img src="${user.image}" style="max-height: 400px; max-width: 400px;"  alt="">
                    </div>
                  </div>
                </div>               
              </div>    
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Blogs from this author</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="blog-list">All blogs</a></li>
              <li class="breadcrumb-item"><a href="user-list">All users</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="card card-solid">
          ...
          <div class="row d-flex align-items-stretch">
            ...
            <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
              <div class="card bg-light">
                <div class="card-header text-muted border-bottom-0">
                  <h4>${blog.title}</h4>
                  <h6>Date of created: ${blog.date}</h6>
                </div>
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                    Author:
                      ...
                      <p class="text-muted text-sm"><b>Descruption of blog: </b> ${blog.description} </p>
                      
                      <ul class="ml-4 mb-0 fa-ul text-muted">
                        <li> <i class="fa-regular fa-comment"></i> Number comments : ${blog.comments.size()}</li>
                        <li> <i class="fa-regular fa-eye"></i> Number seen : ${blog.numberSeen}</li>
                        
                      </ul>
                    </div>
                    <div class="col-5 text-center">
                      <img src="${blog.image}" alt="" class="img-circle img-fluid">
                    </div>
                  </div>                  
                </div>
              </div>
        ...
        <div class="card-footer">
          <nav aria-label="Contacts Page Navigation">
           ...
           <c:if test="${k>1}">
           <li class="page-item"><a class="page-link" href="pagination-author-page?k=${k-1}&username=${user.username}"><i class="fa fa-angle-left"></i></a></li>
           </c:if>
           
           
           <c:forEach var="k" begin="1" end="${c}">
           <c:if test="${k==b}">
           <li class="page-item active"><a class="page-link" href="pagination-author-page?k=${k}&username=${user.username}">${k}</a></li>
           </c:if>
           <c:if test="${k!=b}">
           <li class="page-item"><a class="page-link" href="pagination-author-page?k=${k}&username=${user.username}">${k}</a></li>
           </c:if>
           </c:forEach>           
           ...
           <c:if test="${k<c}">
           <li class="page-item"><a class="page-link" href="pagination-author-page?k=${k+1}&username=${user.username}"><i class="fa fa-angle-right"></i></a></li>
           </c:if>           
