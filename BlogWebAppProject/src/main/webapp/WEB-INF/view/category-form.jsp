              ...
              <form:hidden path="id"/>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <form:textarea path="description" type="text" class="form-control" placeholder="Enter description"/>
                ...
                <div class="custom-control custom-checkbox">
                          ...
                          <label for="customCheckbox1" class="custom-control-label">Is visible in page's footer</label>
                  </div>
                <!-- /.card-body -->
